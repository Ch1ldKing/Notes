...
Bilateral symmetry: The body has a brain, mouth, and sensory organs at the front, and waste is excreted at the rear. Compared to radial symmetry, bilateral symmetry allows for more efficient movement and turning. These organisms have simple navigation abilities, continuing to move forward when the scent increases and turning when the scent decreases. This "turning navigation" ability comes from the brain's control of the bilaterally symmetrical body.

The foundation of emotions and feelings can be traced back to the earliest bilaterally symmetrical animals, whose brains regulate behavioral states through valence and arousal. This mechanism is evident in simple organisms, including nematodes, and leads to distinct behavioral patterns. **Positive valence** (e.g., food) encourages them to remain and explore their environment, while **negative valence** (e.g., predators) prompts them to flee quickly. Arousal determines the intensity of behavior: high arousal results in rapid movement, while low arousal leads to stagnation or slow movement. This persistent emotional state allows animals to continue corresponding behaviors even after the external stimulus has disappeared, enhancing their adaptability.

The stress response is an evolutionary survival mechanism, central to the collaboration of **acute stress response** and **recovery response**. When encountering negative valence stimuli (e.g., threats or danger), neuromodulators like adrenaline and noradrenaline trigger the well-known "fight or flight" response. If stress is not alleviated over time, the acute stress response may transition into chronic stress. The core of chronic stress lies in the adaptive mechanism: prolonged negative stimuli gradually adjust the animal's nervous system to a low-reactivity state, reducing responses to both negative and positive stimuli. This phenomenon is observed in many bilaterally symmetrical animals, such as cockroaches, slugs, and fruit flies. In persistent negative environments, these organisms exhibit "learned helplessness," ceasing attempts to escape or improve their situation.

### Learning

Learning involves the establishment of connections between stimuli and responses. This mechanism is known as the Hebbian learning rule, which states that "neurons that fire together, wire together." Changes in synaptic strength allow neural networks to adapt to the environment. Learning is an ancient mechanism that evolved from early bilaterally symmetrical animals, optimizing navigational behaviors. Its foundation lies in synaptic plasticity and the role of neuromodulators.
### 情感
