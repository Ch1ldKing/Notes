...
Bilateral symmetry, with a brain, mouth, and sensory organs at the front and waste excretion at the rear, allows for more efficient movement and turning compared to radial symmetry. This symmetry enables simple navigation, where organisms continue moving when scent increases and turn when it decreases. This "turning navigation" is controlled by the brain.

Emotions and feelings trace back to early bilaterally symmetrical animals, whose brains regulate behavior through valence and arousal. **Positive valence** (e.g., food) encourages exploration, while **negative valence** (e.g., predators) prompts escape. Arousal determines the intensity of actions—high arousal leads to fast movement, while low arousal causes stagnation. This allows animals to maintain behaviors even after external stimuli disappear, enhancing adaptability.

The stress response is an evolutionary survival mechanism involving **acute stress** and **recovery**. Negative stimuli trigger the "fight or flight" response, but prolonged stress can lead to chronic stress. In chronic stress, the nervous system adapts by reducing reactivity to both negative and positive stimuli. This can lead to "learned helplessness," where animals stop attempting to escape or improve their situation, a phenomenon seen in animals like cockroaches and fruit flies.
