...
这里把1改成2，即改为新时间片为右移两位得出![image.png](https://s2.loli.net/2025/01/06/CBFrqvhoy8APSMk.png)
然后重新编译内核，运行process得到以下结果![image.png](https://s2.loli.net/2025/01/06/HFBQvlOXR4WEpbn.png)可以看到执行时间明显减少，等待时间略微减少了