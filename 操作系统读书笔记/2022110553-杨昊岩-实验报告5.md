...
2. `jiffies`用于记录开机以来的时间，`p->tss.back_link=0`用于初始化`tss`为寄存器映像。所以在他们两个之间调用`fprintk()`，`3`是关联logwen'jian![image.png](https://s2.loli.net/2025/01/04/qNBJxl8MzQZS7oT.png)
3. 