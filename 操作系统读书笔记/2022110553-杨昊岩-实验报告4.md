...
```
6. 由于在linux0.11下不方便，所以先在ubuntu下挂载硬盘映像`./mount-hdc`，将编译好的程序和testlab2拷贝到`/usr/root`路径下。拷贝完后卸载，执行`./dbg-bochsgui`![image.png](https://s2.loli.net/2024/12/17/I8CALgelyMc5tw4.png)
7. 